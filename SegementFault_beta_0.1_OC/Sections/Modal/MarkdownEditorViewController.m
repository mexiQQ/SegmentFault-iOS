...
- (instancetype)init{
    ...
    MarkdownEditorViewController * main = [mainStoryboard instantiateViewControllerWithIdentifier:@"markdownEdit"];
...
- (void)viewDidLoad {
    ...
    self.textView.inputAccessoryView=[MXKeyboardToolbar toolbarViewWithTextView:self.textView];
...
- (void)keyboardWasShown:(NSNotification *)notification
{
    ...
    float height = [self.view bounds].size.height - self.textView.frame.origin.y - keyboardSize.height;
